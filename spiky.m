...
CreateAnalysisMenu(hAnalysis, 'continuous')
CreateAnalysisMenu(hAnalysis, 'discrete')
...
% Run a user-define analysis script.
%
[FV, ~] = GetStruct;
global g_bBatchMode
...
hold on;
ThemeObject(hFill);
set(hFill, 'facecolor', vColor, 'EdgeColor', vColor)
