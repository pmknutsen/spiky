 ...
 *
 *
 * mex -v I/usr/include/atlas/ LDFLAGS="\$LDFLAGS  -L/usr/lib/liblapack.so.3 -llapack -lblas -lm -gfortran" fast_kmeans_step_linx.c -outdir ./
 *-llapack_atlas -llapack -lblas -latlas -lm
 */
